package bryan.braggion.app_Ger_Int
...
class MainActivity : AppCompatActivity() {
    ...
    private fun exibirSite() {
        val dados = Uri.parse("https://pt.wikipedia.org/wiki/Wikip%C3%A9dia:P%C3%A1gina_principal");
    ...
    private fun exibirLocal() {
        //val dados = Uri.parse("geo: 0,0?z=19&q=Mauá"); pesquisa o "q"
        val dados = Uri.parse("geo: -23.66359557580036, -46.46014309222266?z=19");
        val intent: Intent = Intent(Intent.ACTION_VIEW, dados);
        startActivity(intent);
    }
